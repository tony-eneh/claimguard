...
\begin{table*}[!htbp]
	...
	\begin{tabular}{@{}p{2.8cm}p{2cm}p{2.2cm}p{2cm}p{1.8cm}p{1.5cm}p{1.5cm}p{2cm}@{}}
		...
		\midrule
		\textbf{ClaimGuard (This Work)}                 & \textbf{Auto insurance} & \textbf{FNOL, PDFs, images, telem., videos} & \textbf{Pure-Chain ABAC} & \textbf{Yes (CRUD+)}  & \textbf{Yes}               & \textbf{Yes (Gateway)}      & \textbf{Sim. vs RBAC} \\
		\bottomrule
	\end{tabular}
