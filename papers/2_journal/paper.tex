...
Code, configs, and scripts are available in the public artifact repository~\cite{pace-repo}.
...
\bmhead{Data availability}The datasets analyzed during the study are available in the public project repository~\cite{pace-repo} and are available on request.
...
The smart contracts, gateway implementation, and evaluation scripts are available in the public project repository~\cite{pace-repo}.
