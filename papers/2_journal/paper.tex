...
\begin{frontmatter}
	...
	\title{ClaimGuard: Action-Aware Attribute-Based Access Control for Multi-Stakeholder Digital Evidence Governance}
...
\begin{table*}[!htbp]
	...
	\begin{tabular}{@{}p{2.8cm}p{2cm}p{2.2cm}p{2cm}p{1.8cm}p{1.5cm}p{1.5cm}p{2cm}@{}}
		...
		\midrule
		\textbf{ClaimGuard (This Work)}                 & \textbf{Multi-Stakeholder} & \textbf{Resource-Agnostic} & \textbf{Ethereum ABAC} & \textbf{Yes}  & \textbf{Yes}               & \textbf{Yes}      & \textbf{Quantitative \& Qualitative} \\
		\bottomrule
	\end{tabular}
...
\begin{figure}[!htbp]
	...
	\begin{tikzpicture}[
		...
		\node[participant, right=of peg] (chain) {Blockchain\\(ClaimGuard)};
...
\begin{table}[!htbp]
	...
	\begin{tabularx}{\columnwidth}{X c c c c}
		...
		ClaimGuard (Local)     & $60.9 \pm 2.1$  & $69.6 \pm 3.4$  & $78.9 \pm 4.7$  & 1000       \\
		\bottomrule
	\end{tabularx}
	\label{tab:latency}
\end{table}
