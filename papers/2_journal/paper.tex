...
Garcia \emph{et al.}~\cite{garcia2022blockchainmulti} address multi-stakeholder data governance through a blockchain-aided privacy-preserving framework enabling consent management, selective disclosure, and provenance tracking. Their follow-up work~\cite{garcia2022prescription} validates the approach through an e-prescription case study involving patients, pharmacies, physicians, and insurers. These multi-stakeholder systems demonstrate the value of decentralized policy evaluation for cross-organizational scenarios but typically do not address action-aware authorization distinguishing read, modify, and disclose operations, nor do they provide systematic performance comparison against cloud-only baselines.
...
\begin{itemize}
	...
	\item Action-awareness distinguishing read, append, modify, delete, and disclose operations is inconsistently addressed, with most systems treating access as binary allow/deny. Healthcare~\cite{oliveira2022smartaccess, rouhani2021distributed} and multi-stakeholder frameworks~\cite{garcia2022blockchainmulti, garcia2022prescription} focus on consent and selective disclosure but lack action-level authorization models.
...
\begin{figure}
	\centering
	\includegraphics[width=0.45\textwidth]{figures/architecture_pace.pdf}
